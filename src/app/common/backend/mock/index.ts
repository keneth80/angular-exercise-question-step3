...
export const feeds: Feed[] = [
    {
        ...
        userName: '천하무적루피',
        userNickName: 'rupy',
        content: '나는 천하무적 루피 영리하고 발빠른 그리고 무식하게 개발밖에 모르는 바보...',
    ...
    },
    {
        ...
        userName: '천하무적루피',
        userNickName: 'rupy',
        content: '미라클모닝에는 역시 독서가 빠질 수 없지....만 역시 독서는 어려워~~~',
        created: new Date('June 10, 2021 17:21:01').getTime(),
        tags: '#BOOK,#독서',
    ...
    },
    {
        ...
        tags: '#마크업',
        reply: replys.filter((reply: Reply) => reply.feedId === 3),
        image: '/assets/images/img-dummy1.JPG',
        like: 1,
    },
    {
        ...
        created: new Date('June 11, 2021 17:21:01').getTime(),
        tags: '#CSS',
        reply: replys.filter((reply: Reply) => reply.feedId === 4),
        image: '/assets/images/img-dummy2.JPG',
        like: 1,
    },
    {
        ...
        tags: '#CSS',
        reply: replys.filter((reply: Reply) => reply.feedId === 5),
        image: '/assets/images/img-dummy3.JPG',
        like: 1,
    },
    {
        ...
        tags: '#마크업',
        reply: replys.filter((reply: Reply) => reply.feedId === 6),
        image: '/assets/images/img-dummy1.JPG',
        like: 1,
    },
];
